...
public class ServerConnectionMaker  {
	...
	public static  void sendRequest(ConnectionInterface ci){
		...
		.build();
//
		if( HomeActivity.butteryProgressBar != null){
			HomeActivity.butteryProgressBar.setVisibility(View.VISIBLE);
		}
	...
	public static void recieveResponse(Response response)
	{
		...
		if( HomeActivity.butteryProgressBar != null){
			HomeActivity.butteryProgressBar.setVisibility(View.INVISIBLE);
		}
