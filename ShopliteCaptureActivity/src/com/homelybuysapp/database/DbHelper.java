package com.homelybuysapp.database;
		...
		try{
			...
			if(cursor.moveToFirst()){ 
				 while (cursor.isAfterLast() == false) {
					shp = new Shop();
					try{
						com.homelybuysapp.models.Location loc = new com.homelybuysapp.models.Location(cursor.getDouble(cursor.getColumnIndex(SHOP_LAT)) , cursor.getDouble(cursor.getColumnIndex(SHOP_LNG)) );
