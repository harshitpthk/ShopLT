		...
		try {
			 ...
			 locationListener = new LocationListener() {
				...
				public void onLocationChanged(Location mlocation) {
			      // Called when a new location is found by the network location provider.
			    	...
			    	Globals.current_location = new com.shoplite.models.Location(mlocation.getLatitude(),mlocation.getLongitude());
			...
			if (network_enabled){
					...
					if(!made_use_of_location && location.current_location !=null ){
						Globals.current_location = new com.shoplite.models.Location(location.current_location.getLatitude(),location.current_location.getLongitude());
