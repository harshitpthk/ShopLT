...
public class PreviousOrderCard implements ConnectionInterface{
	...
	public void updateView()
	{
		...
		if(orderState == Constants.ORDERState.PACKING.ordinal()){
			...
			getOrderStatusView().setImageDrawable(context.getResources().getDrawable(R.drawable.delivery));
			
		}
		else{
			getOrderStatusView().setImageDrawable(context.getResources().getDrawable(R.drawable.delivered_stamp));
